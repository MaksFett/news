...
export default function Reg() {
    ...
    const RegSchema = Yup.object().shape({
      ...
      user_check: Yup.boolean().isTrue('Обязательное поле')
      //.equals(true, 'Обязательное поле')
    });
        ...
        <div className="container text-center">
          <div className="row">
            <div className="col-lg-12">
              ...
              <Formik initialValues={{ "login" : '', "password" : '', "retyped_password" : '', user_check: false}} 
                ...
                <div>
                  ...
                  <Form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      <a href="/agreement_on_user_data.pdf">Согласие на обработку персональных данных</a>
                      {errors.user_check && touched.user_check ? (
                        <div style = {{color: 'red'}}>{errors.user_check}</div>
                      ) : (<div>&nbsp;</div>)}
                    </div>
